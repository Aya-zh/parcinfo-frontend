...
export default function AjouterDemande() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await api.post('/api/demandes/soumettre', {
        objet: form.objet,
        description: form.description,
        priorite: form.priorite,
        beneficiaire: { id: parseInt(userId) },
        responsable: { id: parseInt(form.idResponsable) },
      });
      navigate('/demandes');
    } catch (err) {
      alert(err.response?.data?.message || err.response?.data || 'Erreur lors de la soumission');
    } finally {
      setLoading(false);
    }
  };
      ...
      <main className="db-main">
        ...
        <div className="db-content">
          <div className="mat-header">
            <div>
              <h1 className="mat-title">Nouvelle Demande</h1>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mat-form-grid">
                ...
                <div className="mat-form-group" style={{ gridColumn: '1 / -1' }}>
                  ...
                  <textarea name="description" value={form.description} onChange={handleChange} placeholder="Décrivez votre demande en détail..." rows={4} className={errors.description ? 'mat-input-error' : ''} />
              ...
              <div className="mat-form-actions">
                ...
                <button type="submit" className="mat-btn-save" disabled={loading}><FiSave size={16} /> {loading ? 'Soumission...' : 'Soumettre la demande'}</button>
              </div>
            </form>
          </div>
        </div>
